...
double rk2(double(*f1)(double, double, double, double, double), double(*f2)(double, double, double, double, double),
    ...
    return preV1 + 0.5 * h * (f + f1(preX + h, preV1 + h * f, preV2 + h * f2(preX, preV2, preV1, p1, p2), p1, p2));
}
...
double rk4(double(*rp)(double, double), double h, double preX, double preV1) {
    ...
    return preV1 +  h * (k1 + 2 * k2 + 2 * k3 + k4)/6;
}
...
double rk4(double(*f1)(double, double, double, double, double), double(*f2)(double, double, double, double, double),
    ...
    k21 = f2(preX, preV2, preV1, p1, p2);
    k12 = f1(preX + 0.5 * h, preV1 + 0.5 * h * k11, preV2 + 0.5 * k21, p1, p2);
    k22 = f2(preX + 0.5 * h, preV2 + 0.5 * k21, preV1 + 0.5 * h * k11, p1, p2);
    k13 = f1(preX + 0.5 * h, preV1 + 0.5 * h * k12, preV2 + 0.5 * k22, p1, p2);
    k23 = f2(preX + 0.5 * h, preV2 + 0.5 * k22, preV1 + 0.5 * h * k12, p1, p2);
    k14 = f1(preX + h, preV1 + h * k13, preV2 + k23, p1, p2);
    k24 = f2(preX + h, preV2 + k23, preV1 + h * k13, p1, p2);
    return preV1 + h * (k11 + 2 * k12 + 2 * k13 + k14)/6;
}